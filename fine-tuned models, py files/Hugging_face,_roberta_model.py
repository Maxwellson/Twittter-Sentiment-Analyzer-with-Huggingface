# -*- coding: utf-8 -*-
"""LP5_hugging face, roberta model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vdy-ogELQcbEMsHg1ZQu4TAd62rsMy-L
...
training_args = TrainingArguments(
    "twitter_sentiment_analysis_roberta_model",           # Directory to save the output files
...
#hhf_WZkwwWpguORUzQqWzOanighgiSRYmohnXh

# Push to HF hub
model.push_to_hub("lindaclara22/twitter-sentiment-analysis-roberta-model")

tokenizer.push_to_hub("lindaclara22/twitter-sentiment-analysis-roberta-model")
