# -*- coding: utf-8 -*-
"""LP5_hugging face, bert-based.ipynb
...
#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

# Push to HF hub
model.push_to_hub("lindaclara22/twitter-sentiment-analysis")

tokenizer.push_to_hub("lindaclara22/twitter-sentiment-analysis")
